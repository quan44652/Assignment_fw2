        ...
        <div className={styles.detailProduct__right}>
          ...
          <div className={styles.productDetail__btn__buy}>
            <div className={`${styles.btn_red__buy} ${styles.btn__buy}`}>
              <strong className={styles.productDetail__btn__title}>
                Mua ngay
              </strong>
              <br />
              <span>Giao hàng tận nhà(COD)</span>
              <br />
            ...
            <div className={`${styles.btn_yellow__buy} ${styles.btn__buy}`}>
              <svg
                ...
                height={30}
                fill="currentColor"
                className={`${styles.bi} ${styles.bi_cart3}`}
                viewBox="0 0 16 16"
              >
          ...
          <div className={styles.detailProduct__endow}>
            ...
            <div>
              <svg
                ...
                height={16}
                fill="currentColor"
                className={`${styles.bi} ${styles.bi_check_lg}`}
                viewBox="0 0 16 16"
              >
                <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
              </svg>
              <span>
                Ưu đãi đến 300.000đ khi mở Ví hoặc thanh toán qua VNPAY Mở thẻ
                tín dụng VIB
              </span>
              <br />
              <svg
              ...
              <span>
                Duyệt nhanh chỉ 15 phút, Liên hệ cửa hàng hoặc 1900.2091 để được
                hướng dẫn.
              </span>
              <br />
            </div>
      ...
      <section className={styles.detailProduct__parameter}>
        <div className={styles.detailProduct__parameter__left}>
          <span>
            ...
            được nhập trực tiếp từ Công ty TNHH Apple Việt Nam. HoangHa Mobile
            là nhà bán lẻ ủy quyền chính thức của Apple tại Việt Nam.
          </span>
          <br />
          <br />
          <img className={styles.diachi} src="../images/diachi.webp" alt="" />
          <strong>
            Mua điện thoại iPhone 11 chính hãng, giá rẻ tại Hoàng Hà Mobile
          </strong>
          <br />
          <br />
          <span>
            iPhone 11 - siêu phẩm được mong chờ nhất năm 2019 của Apple chuẩn bị
            ra mắt. Với những cải tiến vượt trội, phiên bản iPhone mới nhất hứa
            hẹn sẽ làm bùng nổ thị trường công nghệ.
          </span>
          <br />
          <br />
          <strong>
            Thiết kế cực kỳ ấn tượng với màn hình có độ phân giải cao
          </strong>
          <img
            className={styles.diachi}
            src="../images/morePhone.webp"
            alt=""
          />
        </div>
        <div className={styles.detailProduct__parameter__right}>
          ...
          <img
            className={styles.parammeter__right__img}
            src="../images/sp1.webp"
            alt=""
          />
